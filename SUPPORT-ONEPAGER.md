# Support the Camp — one-page overview

**For:** Roy & the Kady Youth Sheep Camp, and Confluence Colorado
**What this is:** how the website will let people support the camp — and get a thank-you gift at higher levels.
...
1. **Give any amount** — donate directly, no gift, **100% tax-deductible.**
2. **Support with a thank-you** — pick a level and receive a gift:
...
## What we need to decide together (with Confluence)

1. Use **Confluence's Stripe** with simple payment links, or a donation tool Confluence already
   has?
2. Who sets up the links, and which **print-on-demand** company do we use?
3. Confirm the **gift values** above with Confluence's accountant.
4. The **receipt wording** and Confluence's tax ID to show donors.

---

*Nothing is live to the public yet — the site sits behind the "coming soon" page until it's
approved. This page is a plan to talk through, not a finished build.*
